...
type ServiceInterface interface {
	...
	Apply(ctx context.Context, service *servicev1.ServiceApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Service, err error)
	ApplyStatus(ctx context.Context, service *servicev1.ServiceApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Service, err error)
	ServiceExpansion
}
...
func newServices(c *ExampleV1Client, namespace string) *services {
	return &services{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *services) Apply(ctx context.Context, service *servicev1.ServiceApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Service, err error) {
	if service == nil {
...
func (c *services) ApplyStatus(ctx context.Context, service *servicev1.ServiceApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Service, err error) {
	if service == nil {
		return nil, fmt.Errorf("service provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
