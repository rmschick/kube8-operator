...
import (
	...
	v1 "github.com/FishtechCSOC/terminal-poc-deployment/pkg/generated/listers/service/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ExampleV1().Services(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ExampleV1().Services(namespace).Watch(context.TODO(), options)
			},
		},
		&servicev1.Service{},
		resyncPeriod,
...
func (f *serviceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&servicev1.Service{}, f.defaultInformer)
}
