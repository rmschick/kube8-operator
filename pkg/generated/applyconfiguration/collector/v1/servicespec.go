...
func (b *ServiceSpecApplyConfiguration) WithCollector(value *CollectorInfoApplyConfiguration) *ServiceSpecApplyConfiguration {
	b.Collector = value
	return b
}
...
func (b *ServiceSpecApplyConfiguration) WithTenant(value *TenantInfoApplyConfiguration) *ServiceSpecApplyConfiguration {
	b.Tenant = value
	return b
}
...
func (b *ServiceSpecApplyConfiguration) WithEnvironment(value string) *ServiceSpecApplyConfiguration {
	b.Environment = &value
	return b
}
